...
//   try {
//     const { deposit_amount, transaction_id } = req.body;

//     if (!deposit_amount || !transaction_id) {
//       return res
//         .status(400)
//         .json({ message: "Amount and transaction ID are required." });
//     }
...
//     // console.log("isAllowedToDeposit:", user.isAllowedToDeposit);
